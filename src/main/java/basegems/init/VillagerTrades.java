...
public class VillagerTrades extends cyano.basemetals.init.VillagerTrades {
	...
	public static void init() {
		...
		final int size = basegems.init.Materials.getAllMetals().size();
		...
		basegems.init.Items.getItemsByMetal().entrySet().stream()
		...
		for(MetalMaterial m : basegems.init.Materials.getAllMetals()) {
