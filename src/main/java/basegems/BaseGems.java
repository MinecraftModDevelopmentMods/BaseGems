...
import basegems.data.AdditionalLootTables;
import basegems.data.DataConstants;
...
@Mod(
		...
		updateJSON = "https://raw.githubusercontent.com/jriwanek/BaseGems/master/update.json")
...
//		event.getModMetadata();
	...
	private void clientPreInit(FMLPreInitializationEvent event) {
		// client-only code
		basegems.init.Fluids.bakeModels(MODID);
	}
	...
	public void init(FMLInitializationEvent event) {
		basegems.init.Recipes.init();
		basegems.init.Achievements.init();
	...
	private void clientInit(FMLInitializationEvent event) {
		// client-only code
		basegems.init.Items.registerItemRenders(event);
		basegems.init.Blocks.registerItemRenders(event);
	}
