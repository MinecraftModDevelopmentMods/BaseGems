...
public class Config {
	...
	public static void init() {
		...
		// METALS
		Options.enableAgate = configuration.getBoolean("EnableAgate", MATERIALS_CAT, true, "Enable Agate Items and Materials");
		Options.enableAlexandrite = configuration.getBoolean("EnableAlexandrite", MATERIALS_CAT, true, "Enable Alexandrite Items and Materials");
		Options.enableAmber = configuration.getBoolean("EnableAmber", MATERIALS_CAT, true, "Enable Amber Items and Materials");
		Options.enableAmethyst = configuration.getBoolean("EnableAmethyst", MATERIALS_CAT, true, "Enable Amethyst Items and Materials");
		Options.enableAmetrine = configuration.getBoolean("EnableAmetrine", MATERIALS_CAT, true, "Enable Ametrine Items and Materials");
		Options.enableAquamarine = configuration.getBoolean("EnableAquamarine", MATERIALS_CAT, true, "Enable Aquamarine Items and Materials");
		Options.enableBeryl = configuration.getBoolean("EnableBeryl", MATERIALS_CAT, true, "Enable Beryl Items and Materials");
		Options.enableBlackDiamond = configuration.getBoolean("EnableBlackDiamond", MATERIALS_CAT, true, "Enable Black Diamond Items and Materials");
		Options.enableBlueTopaz = configuration.getBoolean("EnableBlueTopaz", MATERIALS_CAT, true, "Enable Blue Topaz Items and Materials");
		Options.enableCarnelian = configuration.getBoolean("EnableCarnelian", MATERIALS_CAT, true, "Enable Carnelian Items and Materials");
		Options.enableCitrine = configuration.getBoolean("EnableCitrine", MATERIALS_CAT, true, "Enable Citrine Items and Materials");
		Options.enableGarnet = configuration.getBoolean("EnableGarnet", MATERIALS_CAT, true, "Enable Garnet Items and Materials");
		Options.enableGoldenBeryl = configuration.getBoolean("EnableGoldenBeryl", MATERIALS_CAT, true, "Enable Golden Beryl Items and Materials");
		Options.enableHeliodor = configuration.getBoolean("EnableHeliodor", MATERIALS_CAT, true, "Enable Heliodor Items and Materials");
		Options.enableIndicolite = configuration.getBoolean("EnableIndicolite", MATERIALS_CAT, true, "Enable Indicolite Items and Materials");
		Options.enableIolite = configuration.getBoolean("EnableIolite", MATERIALS_CAT, true, "Enable Iolite Items and Materials");
		Options.enableJade = configuration.getBoolean("EnableJade", MATERIALS_CAT, true, "Enable Jade Items and Materials");
		Options.enableJasper = configuration.getBoolean("EnableJasper", MATERIALS_CAT, true, "Enable Jasper Items and Materials");
		Options.enableLepidolite = configuration.getBoolean("EnableLepidolite", MATERIALS_CAT, true, "Enable Lepidolite Items and Materials");
		Options.enableMalachite = configuration.getBoolean("EnableMalachite", MATERIALS_CAT, true, "Enable Malachite Items and Materials");
		Options.enableMoldavite = configuration.getBoolean("EnableMoldovite", MATERIALS_CAT, true, "Enable Moldavite Items and Materials");
		Options.enableMoonstone = configuration.getBoolean("EnableMoonstone", MATERIALS_CAT, true, "Enable Moonstone Items and Materials");
		Options.enableMorganite = configuration.getBoolean("EnableMorganite", MATERIALS_CAT, true, "Enable Morganite Items and Materials");
		Options.enableOnyx = configuration.getBoolean("EnableOnyx", MATERIALS_CAT, true, "Enable Onyx Items and Materials");
		Options.enableOpal = configuration.getBoolean("EnableOpal", MATERIALS_CAT, true, "Enable Opal Items and Materials");
		Options.enablePeridot = configuration.getBoolean("EnablePeridot", MATERIALS_CAT, true, "Enable Peridot Items and Materials");
		Options.enableRuby = configuration.getBoolean("EnableRuby", MATERIALS_CAT, true, "Enable Ruby Items and Materials");
		Options.enableSapphire = configuration.getBoolean("EnableSapphire", MATERIALS_CAT, true, "Enable Sapphire Items and Materials");
		Options.enableSpinel = configuration.getBoolean("EnableSpinel", MATERIALS_CAT, true, "Enable Spinel Items and Materials");
		Options.enableTanzanite = configuration.getBoolean("EnableTanzanite", MATERIALS_CAT, true, "Enable Tanzanite Items and Materials");
		Options.enableTopaz = configuration.getBoolean("EnableTopaz", MATERIALS_CAT, true, "Enable Topaz Items and Materials");
		Options.enableTurquoise = configuration.getBoolean("EnableTurquoise", MATERIALS_CAT, true, "Enable Turquoise Items and Materials");
		Options.enableVioletSapphire = configuration.getBoolean("EnableVioletSapphire", MATERIALS_CAT, true, "Enable Violet Sapphire Items and Materials");
